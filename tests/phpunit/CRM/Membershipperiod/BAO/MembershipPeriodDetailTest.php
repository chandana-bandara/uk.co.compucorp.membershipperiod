...
* @group headless
*/
class CRM_Membershipperiod_BAO_MembershipPeriodDetailTest extends \PHPUnit_Framework_TestCase implements HeadlessInterface, HookInterface, TransactionalInterface {
	...
	private function createNewMembershipPeriodAndGetDetails($membershipId, $contributionId=null, $numberOfTerms, $membershipTypeId, $startDate, $endDate, $membershipDurationUnit, $membershipDurationInterval){
		...
		if ($params['membership_duration_unit'] == MembershipDuration::LIFETIME ){
			$params['end_date'] = CRM_Membershipperiod_BAO_MembershipPeriodDetail::$lifetimeMembershipEndDate;
		}
